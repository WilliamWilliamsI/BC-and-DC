 ...
 * @Comment: The UTXOPool class that represents the current set of outstanding
...
public class UTXOPool {
    ...
    /**
     * @return the transaction output corresponding to UTXO {@code utxo},
     * or null if {@code utxo} is not in the pool.
     */
